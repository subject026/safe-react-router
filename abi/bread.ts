export const breadAbi = [
  ...
  },
  {
    ...
    name: "rescueToken",
    inputs: [
      { name: "tok", type: "address", internalType: "address" },
      { name: "amount", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  ...
  { type: "error", name: "MismatchAmount", inputs: [] },
  { type: "error", name: "MismatchArray", inputs: [] },
  { type: "error", name: "NativeTransferFailed", inputs: [] },
  { type: "error", name: "NotInitializing", inputs: [] },
  { type: "error", name: "OnlyClaimers", inputs: [] },
  {
    type: "error",
